...
extern "C" const char* plugin_name() { return "Test Plugin"; }
...
public:
    ...
    void OnCreate() override
    {
        ...
        // auto& model = m_ent.Has<PEANUT::CustomModelComponent>() ? m_ent.Get<PEANUT::CustomModelComponent>()
        //                                                         : m_ent.Add<PEANUT::CustomModelComponent>();
        ...
        // } }); model.mesh.vertices.emplace_back(Vertex { glm::vec3 { 1, 1, 0 }, glm::vec3 { 0, 0, -1 }, glm::vec2 { 1,
        // 1 } }); model.mesh.indices.emplace_back(0); model.mesh.indices.emplace_back(1);
        // model.mesh.indices.emplace_back(2);

        LOG_DEBUG("TestPlugin created");
    }

    void OnDestroy() override { LOG_DEBUG("TestPlugin Destroyed"); }

    void RuntimeBegin() override { LOG_DEBUG("TestPlugin runtime begin"); }

    void RuntimeEnd() override { LOG_DEBUG("TestPlugin runtime end"); }
